...
/* MIPI PHY Macros */
        ...
        {
            .pll_settings = /* Calculated MIPI PHY PLL frequency: 1000000000 Hz (error 0.00%) = 20000000 Hz / 1 * 50.00 */{.div      = 1 - 1,.mul_int  = 50 - 1,.mul_frac = 0 /* Value: 0 */},
            .lp_divisor   = 5 - 1,
...
mipi_dsi_instance_ctrl_t g_mipi_dsi0_ctrl;
        ...
        const mipi_dsi_cfg_t g_mipi_dsi0_cfg =
        {
            ...
            .vertical_back_porch      = (19 - 1),
            .vertical_front_porch     = (1300 - 1280 - 19 - 1),
            .vertical_sync_polarity   = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),


            .horizontal_active_lines  = 800,
            .horizontal_sync_lines    = 6,
            .horizontal_back_porch    = (34 - 6),
            .horizontal_front_porch   = (840 - 800 - 34 - 6),
            .horizontal_sync_polarity = (DISPLAY_SIGNAL_POLARITY_LOACTIVE != DISPLAY_SIGNAL_POLARITY_HIACTIVE),

            .video_mode_delay         = 175 /* This value was calculated by FSP. An override is available but not recommended for most users */,
...
/** Display framebuffer */
        ...
        uint8_t fb_background[2][DISPLAY_BUFFER_STRIDE_BYTES_INPUT0 * DISPLAY_VSIZE_INPUT0] BSP_ALIGN_VARIABLE(64) BSP_PLACE_IN_SECTION(".bss.nocache_sdram");
        #else
        ...
        const glcdc_extended_cfg_t g_display_extend_cfg =
        {
            ...
            .clock_div_ratio       = GLCDC_PANEL_CLK_DIVISOR_6, //GLCDC_PANEL_CLK_DIVISOR_6,
